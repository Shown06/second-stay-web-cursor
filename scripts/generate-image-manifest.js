...
const categoryMeta = {
    '01_sauna': { id: 'sauna', label: 'サウナ', description: 'プライベートサウナで極上のリラックスタイムを' },
    '02_living': { id: 'living', label: 'リビング', description: '広々としたリビングで寛ぎのひとときを' },
    '03_bathroom': { id: 'bathroom', label: 'バスルーム', description: '清潔感あふれるバスルームで旅の疲れを癒す' },
    '04_bedroom': { id: 'bedroom', label: 'ベッドルーム', description: '上質な眠りをお約束するプライベート空間' },
    '05_kitchen': { id: 'kitchen', label: 'キッチン', description: '本格的な調理器具を備えたフルキッチン' },
...
const dirs = fs.readdirSync(facilitiesDir)
    .filter(name => {
